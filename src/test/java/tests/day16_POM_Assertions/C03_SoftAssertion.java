...
public class C03_SoftAssertion {
    ...
    public void hardAssertion(){
        ...
        Assert.assertTrue(sayi>100, "sayi 100'den buyuk olmali"); // sayi yuzden buyuk mu?

        Assert.assertTrue(sayi<1000, "Sayi 1000'den kucuk olmali"); // sayi 1000 den buyuk mu?

        Assert.assertFalse(sayi%3==0, "Sayi 3'e bolunebilmeli"); // sayinin 3 ile bolunemedigini test edin
